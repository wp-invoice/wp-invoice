<?php
echo '<script type="text/javascript">Conekta.setPublishableKey("' . trim($invoice['billing'][$this->type]['settings'][$invoice['billing'][$this->type]['settings']['mode']['value'].'_publishable_key']['value']) . '");</script>';
?>
        ...
        <ul class="wpi_checkout_block">
          ...
          <li class="wpi_checkout_row">
              <div class="control-group">
                  <label class="control-label" for="card-name"><?php _e('Card Name', ud_get_wp_invoice()->domain); ?></label>
                  <div class="controls">
                      <input type="text" autocomplete="off" id="card-name" class="card-name text-input" />
                  </div>
              </div>
          </li>
          <li class="wpi_checkout_row">
          ...
          <li class="wpi_checkout_row">
              <div class="control-group">
                  ...
                  <div class="controls">
                      <input type="password" size="4" autocomplete="off" id="card-cvc" class="card-cvc text-input" />
                  </div>
              </div>
          </li>
