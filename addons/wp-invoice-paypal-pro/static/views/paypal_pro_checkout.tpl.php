...
<ul class="wpi_checkout_block wpi_checkout_customer_information">
  <li class="section_title"><?php _e( 'Customer Information', ud_get_wp_invoice_paypal_pro()->domain ); ?></li>
  ...
  <li class="wpi_checkout_row_street wpi_checkout_row">
    <div class="control-group">
      <label class="control-label" for="wpi_checkout_payment_street">
        <?php _e( 'Street', ud_get_wp_invoice_paypal_pro()->domain ); ?>
      </label>
      <div class="controls">
  ...
  <li class="wpi_checkout_row_city wpi_checkout_row">
    <div class="control-group">
      <label class="control-label" for="wpi_checkout_payment_city">
        <?php _e( 'City', ud_get_wp_invoice_paypal_pro()->domain ); ?>
      </label>
      <div class="controls">
  ...
  <li class="wpi_checkout_row_zip wpi_checkout_row">
    <div class="control-group">
      <label class="control-label" for="wpi_checkout_payment_zip">
        <?php _e( 'Zip/Postal Code', ud_get_wp_invoice_paypal_pro()->domain ); ?>
      </label>
      <div class="controls">
  ...
  <li class="wpi_checkout_row_state wpi_checkout_row">
    <div class="control-group">
      <label class="control-label" for="wpi_checkout_payment_state">
        <?php _e( 'State', ud_get_wp_invoice_paypal_pro()->domain ); ?>
      </label>
      <div class="controls">
        <select name="wpi_checkout[billing][state]" id="state" class="text-input">
          <option value=""><?php _e('No', ud_get_wp_invoice_paypal_pro()->domain); ?></option>
          <?php foreach (UsabilityDynamics\WPI_PPP\HelperCodes::$states as $state_area => $area_states): ?>
  ...
  <li class="wpi_checkout_row_state wpi_checkout_row">
    <div class="control-group">
      <label class="control-label" for="wpi_checkout_payment_country">
        <?php _e( 'Country', ud_get_wp_invoice_paypal_pro()->domain ); ?>
      </label>
      <div class="controls">
...
<ul class="wpi_checkout_block wpi_checkout_billing_information">
  ...
  <li class="wpi_checkout_row_card_type wpi_checkout_row">
    <div class="control-group">
      <label class="control-label" for="wpi_checkout_payment_card_type">
        <?php _e( 'Card Type', ud_get_wp_invoice_paypal_pro()->domain ); ?>
      </label>
      <div class="controls">
        <select class="text-input" name="wpi_checkout[billing][credit_card_type]" id="credit-card-type">
