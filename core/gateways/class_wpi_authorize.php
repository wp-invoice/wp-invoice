      ...
      <tr class="wpi_recurring_start_date" style="display:<?php echo !empty( $this_invoice[ 'recurring' ] ) && $this_invoice[ 'recurring' ][ $this->type ][ 'send_invoice_automatically' ] == 'on' ? 'none;' : ''; ?>">
        ...
        <td>
          <div>
            ...
            <?php echo WPI_UI::input( "id=r_start_date_aa&name=wpi_invoice[recurring][" . $this->type . "][start_date][year]&value=" . ( !empty( $this_invoice[ 'recurring' ][ $this->type ] ) ? $this_invoice[ 'recurring' ][ $this->type ][ 'start_date' ][ 'year' ] : '' ) . "&special=size='2' maxlength='4' autocomplete='off'" ) ?>
            <br/>
